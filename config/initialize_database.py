...
try:
    ...
    print("An error occurred while initializing the database:", e.args[0])
except FileNotFoundError:
    print("The File was not found in the project scope.")
except FileExistsError:
    print("The File does not exist in the project scope.")
except:
