...
"""
week_empty_df function creates an empty dataframe that already contains days when GP has their weekends.
It can get populated using .loc pinpointing the date and time of bookings that we get from the database.
This function return a DataFrame without tabulate formatting  
"""
...
# This snippet of code fetches the bookings for a week specified and populates the empty week dataframe
# In your method you will have to dynamically generate the the end date and
# input in into the SQL query

week_empt_df = week_empty_df('2020-12-08',10)
